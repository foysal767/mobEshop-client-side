...
const ProductsInfo = () => {
    return (
        <section className="p-4 my-6 md:p-8 bg-accent text-primary">
            <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div className="flex overflow-hidden rounded-lg">
                    ...
                    <div className="flex items-center justify-between flex-1 p-3">
                        ...
                        <p className="text-2xl font-semibold">Satisfactions</p>
                    </div>
                </div>
                <div className="flex overflow-hidden rounded-lg">
                    <div className="flex items-center justify-center px-4">
                    ...
                    <div className="flex items-center justify-between flex-1 p-3">
                        <p className="text-2xl font-semibold">20 L</p>
                        <p className="text-2xl font-semibold">Coffee</p>
                    </div>
                </div>
            </div>
        </section>
